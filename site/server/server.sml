...
fun main () =
    Server.listenAndServe ("", 4334, (fn (req) =>
        case Request.path (req) of
          ...
          | "/documentation/container/list" => serveFile "./dist/templates/documentation/Container/PONYO_CONTAINER_LIST.html"
          | "/documentation/container/tree/binarysearch" => serveFile "./dist/templates/documentation/Container/Tree/PONYO_CONTAINER_TREE_BINARYSEARCH.html"
